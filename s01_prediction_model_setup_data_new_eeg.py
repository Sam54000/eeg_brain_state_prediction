...
sub = '01' # 
ses = '01' # 01 021
task = 'rest_run-01' #'checker_run-01' 'rest_run-01' , 'tp_run-01', 'tp_run-02'
...
for sub in subjects:
    ...
    for ses in sessions:
        for task in tasks:
            ...
            RESPIRATION_DATA_RESAMPLED = RESPIRATION_DATA_RESAMPLED.loc[:min_length, :]

            DATA_EEGbandsEnvelopes = {
                'data': EEGbandsEnvelopes_resampled[:, :min_length, :],
                'frequencies': EEGbandsEnvelopes_data['frequencies'],
                'channel_info': EEGbandsEnvelopes_data['channels_info'],
                'time': fmri_time_resampled[:min_length]
                }

            DATA_CustomEnvelopes = {
                'data': CustomEnvelopes_resampled[:, :min_length, :],
            ...
            DATA_MorletTFR = {
                    'data': MorletTFR_resampled[:, :min_length, :],
            ...
            print(f"PUPIL_DATA_RESAMPLED {PUPIL_DATA_RESAMPLED.shape}")
            print(f"RESPIRATION_DATA_RESAMPLED {RESPIRATION_DATA_RESAMPLED.shape}")
            print(f"RESPIRATION_DATA_RESAMPLED {EEGbandsEnvelopes_resampled.shape}")
            print(f"RESPIRATION_DATA_RESAMPLED {CustomEnvelopes_resampled.shape}")
            print(f"RESPIRATION_DATA_RESAMPLED {MorletTFR_resampled.shape}")
            print(f"===================================================================")
