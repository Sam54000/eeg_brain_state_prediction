...
import utils_gfp_chang as utils
import numpy as np
...
if __name__ == "__main__":
    ...
    parser.add_argument("--additional_info", type=str, default = "CapsGS", required=False, help="Additional info")
    ...
    config = utils.ModelConfig(
        ...
        caps = ["GS",
                ...
                "CAP7", 
                "CAP8"],
        nb_desired_features=[1],
        data_root=Path("/data2/Projects/eeg_fmri_natview/chang_data/derivatives"),
        data_directory="/home/slouviot/01_projects/eeg_brain_state_prediction/data/chang_data/gfp",
        task = args.task,
