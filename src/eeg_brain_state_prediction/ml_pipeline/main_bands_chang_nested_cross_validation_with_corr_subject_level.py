...
import utils_bands_chang_nested_cross_validationy_with_corr as utils
import numpy as np
...
def main(config: "utils.ModelConfig") -> None:
    ...
    for subject in architecture.subjects[6:]:
        #if full_path.exists():
...
if __name__ == "__main__":
    ...
    parser.add_argument("--additional_info", type=str, default = "", required=False, help="Additional info")
